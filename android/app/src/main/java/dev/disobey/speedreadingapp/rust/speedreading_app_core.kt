...
data class AppState (
    ...
    , 
    var `currentWordIndex`: kotlin.ULong
    , 
...
public object FfiConverterTypeAppState: FfiConverterRustBuffer<AppState> {
    override fun read(buf: ByteBuffer): AppState {
        return AppState(
            ...
            FfiConverterOptionalTypeWordDisplay.read(buf),
    ...
    override fun allocationSize(value: AppState) = (
            ...
            FfiConverterOptionalTypeWordDisplay.allocationSize(value.`display`) +
            ...
            FfiConverterULong.allocationSize(value.`currentWordIndex`) +
    ...
    override fun write(value: AppState, buf: ByteBuffer) {
            ...
            FfiConverterOptionalTypeWordDisplay.write(value.`display`, buf)
            ...
            FfiConverterULong.write(value.`currentWordIndex`, buf)
 ...
 * @suppress
 */
public object FfiConverterTypeWordDisplay: FfiConverterRustBuffer<WordDisplay> {
    override fun read(buf: ByteBuffer): WordDisplay {
        return WordDisplay(
            FfiConverterSequenceTypeWordSegment.read(buf),
        )
    }

    override fun allocationSize(value: WordDisplay) = (
            FfiConverterSequenceTypeWordSegment.allocationSize(value.`words`)
    )

    override fun write(value: WordDisplay, buf: ByteBuffer) {
            FfiConverterSequenceTypeWordSegment.write(value.`words`, buf)
    }
}
...
data class WordSegment (
    var `before`: kotlin.String
    , 
    var `anchor`: kotlin.String
    , 
    var `after`: kotlin.String
 ...
 * @suppress
 */
public object FfiConverterTypeWordSegment: FfiConverterRustBuffer<WordSegment> {
    override fun read(buf: ByteBuffer): WordSegment {
        return WordSegment(
            FfiConverterString.read(buf),
            FfiConverterString.read(buf),
            FfiConverterString.read(buf),
    ...
    override fun allocationSize(value: WordSegment) = (
    ...
    override fun write(value: WordSegment, buf: ByteBuffer) {
            FfiConverterString.write(value.`before`, buf)
            FfiConverterString.write(value.`anchor`, buf)
            FfiConverterString.write(value.`after`, buf)
    }
}
...
sealed class AppAction {
    ...
    object Play : AppAction()
    
    
    object Pause : AppAction()
    
    
    object Toggle : AppAction()
    
    
    data class SeekToProgress(
        val `percent`: kotlin.Float) : AppAction()
    ...
    data class SetWordsPerGroup(
        val `n`: kotlin.UInt) : AppAction()
...
public object FfiConverterTypeAppAction : FfiConverterRustBuffer<AppAction>{
    override fun read(buf: ByteBuffer): AppAction {
        return when(buf.getInt()) {
            ...
            3 -> AppAction.LoadText(
                FfiConverterString.read(buf),
                )
            4 -> AppAction.FileSelected(
                FfiConverterString.read(buf),
                )
            5 -> AppAction.Play
            6 -> AppAction.Pause
            7 -> AppAction.Toggle
            8 -> AppAction.SeekToProgress(
                FfiConverterFloat.read(buf),
                )
            9 -> AppAction.SetWpm(
                FfiConverterUInt.read(buf),
                )
            10 -> AppAction.SetWordsPerGroup(
                FfiConverterUInt.read(buf),
                )
            11 -> AppAction.Replay
...
public object FfiConverterTypeAppUpdate : FfiConverterRustBuffer<AppUpdate>{
    override fun read(buf: ByteBuffer): AppUpdate {
        return when(buf.getInt()) {
            ...
            2 -> AppUpdate.PlaybackTick(
                FfiConverterTypeWordDisplay.read(buf),
                FfiConverterFloat.read(buf),
                FfiConverterULong.read(buf),
                )
            else -> throw RuntimeException("invalid enum value, something is very wrong!!")
    ...
    override fun allocationSize(value: AppUpdate) = when(value) {
        ...
        is AppUpdate.PlaybackTick -> {
            ...
            (
                4UL
                + FfiConverterTypeWordDisplay.allocationSize(value.`display`)
                + FfiConverterFloat.allocationSize(value.`progressPercent`)
                + FfiConverterULong.allocationSize(value.`currentWordIndex`)
            )
        }
    ...
    override fun write(value: AppUpdate, buf: ByteBuffer) {
        when(value) {
            ...
            is AppUpdate.PlaybackTick -> {
                buf.putInt(2)
                FfiConverterTypeWordDisplay.write(value.`display`, buf)
                FfiConverterFloat.write(value.`progressPercent`, buf)
                FfiConverterULong.write(value.`currentWordIndex`, buf)
                Unit
            }
 ...
 * @suppress
 */
public object FfiConverterOptionalTypeWordDisplay: FfiConverterRustBuffer<WordDisplay?> {
    override fun read(buf: ByteBuffer): WordDisplay? {
        if (buf.get().toInt() == 0) {
            return null
        }
        return FfiConverterTypeWordDisplay.read(buf)
    }

    override fun allocationSize(value: WordDisplay?): ULong {
        if (value == null) {
            return 1UL
        } else {
            return 1UL + FfiConverterTypeWordDisplay.allocationSize(value)
        }
    }
 ...
 * @suppress
 */
public object FfiConverterSequenceTypeWordSegment: FfiConverterRustBuffer<List<WordSegment>> {
    override fun read(buf: ByteBuffer): List<WordSegment> {
        val len = buf.getInt()
        return List<WordSegment>(len) {
            FfiConverterTypeWordSegment.read(buf)
        }
    }

    override fun allocationSize(value: List<WordSegment>): ULong {
        val sizeForLength = 4UL
        val sizeForItems = value.map { FfiConverterTypeWordSegment.allocationSize(it) }.sum()
        return sizeForLength + sizeForItems
    }

    override fun write(value: List<WordSegment>, buf: ByteBuffer) {
        buf.putInt(value.size)
        value.iterator().forEach {
            FfiConverterTypeWordSegment.write(it, buf)
        }
    }
}
